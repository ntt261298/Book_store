...
class User extends React.Component {
  ...
  render() {
    ...
    return (
        ...
        <div class="prf-navbar" style="max-width:100%;">
        ...
        <div class="merged-row-1">
            <a class="prf-navbar" href="information.html"> 
            ...
            <a class="prf-navbar" href="library.html"> 
                <img src="icon/library-books.svg" style="padding-right: 20px"/>
                Library
            </a> 
        </div>
        ...
        <div class="prf-grid-info">
            ...
            <div>
                ...
                <!-- Year -->
                <select class="prf-select" id="year-of-birth" name="year-of-birth"><option class="prf-option" value="0" disabled selected>Year</option><option class=prf-option value="2018">2018</option>
